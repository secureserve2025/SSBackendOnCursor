-- CLEAR ALL BUSINESS DATA - KEEP STRUCTURE AND AUTH - FIXED VERSION
...
BEGIN
    ...
    RAISE NOTICE 'Disabled all triggers temporarily for cleanup';
END $$;
...
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE NOTICE 'No sequences found to reset';
    END IF;
END $$;
...
BEGIN
    ...
    RAISE NOTICE '2. Users can signup with new profiles (all validation works)';
    RAISE NOTICE '3. Create projects and test all functionality';
    RAISE NOTICE '4. All features will be active:';
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'DATA CLEANUP COMPLETE - READY FOR FEATURE IMPLEMENTATION!';
END $$;
