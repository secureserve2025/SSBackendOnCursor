-- Check and Fix Freelancer Validation Function
-- This script checks if the validate_freelancer_complete function exists and creates it if needed
...
BEGIN
    ...
    RETURN QUERY SELECT 
        true, -- exists_in_db
        true, -- is_active
        (missing_fields = ''), -- profile_complete
        freelancer_record.freelancer_id,
        freelancer_record.full_name,
        freelancer_record.email,
        freelancer_record.mobile_number,
...
-- Test the function with a sample freelancer ID
SELECT 'Testing validate_freelancer_complete function' as test_description;
SELECT * FROM validate_freelancer_complete('F123456789') LIMIT 1;
...
AND routine_name LIKE '%freelancer%' 
