-- =============================================================================
-- CORRECTED USER RECORD DELETION SCRIPT
-- =============================================================================
...
-- Delete work products related to these users (work_products has freelancer_id, not client_id)
...
-- Delete verification reports related to these users (verification_reports has freelancer_id, not client_id)
