-- =============================================================================
-- FINAL USER RECORD DELETION SCRIPT
-- =============================================================================
-- This script deletes all records related to the specified email addresses
-- from all tables in your Supabase database
-- 
-- TARGET EMAILS:
-- - sd@gmail.com
...
-- =============================================================================
-- STEP 4: DELETE FROM DELIVERABLES TABLE
-- =============================================================================

-- Delete deliverables related to these users
...
-- =============================================================================
-- STEP 5: DELETE FROM PROJECT_MESSAGES TABLE
-- =============================================================================

-- Delete project messages related to these users
...
-- =============================================================================
-- STEP 7: DELETE FROM PROJECTS TABLE
-- =============================================================================
...
-- =============================================================================
-- STEP 8: DELETE FROM CLIENT_PROFILES TABLE
-- =============================================================================
...
-- =============================================================================
-- STEP 9: DELETE FROM FREELANCER_PROFILES TABLE
-- =============================================================================
...
-- =============================================================================
-- STEP 10: DELETE FROM AUTH.USERS TABLE (AUTHENTICATION)
-- =============================================================================
...
UNION ALL
SELECT 'Remaining project_messages' as check_type, COUNT(*) as count
...
UNION ALL
SELECT 'Remaining deliverables' as check_type, COUNT(*) as count
FROM deliverables 
WHERE project_id IN (
    SELECT id FROM projects 
    WHERE client_id IN (
...
UNION ALL
SELECT 'Remaining work_products' as check_type, COUNT(*) as count
FROM work_products 
WHERE project_id IN (
    SELECT id FROM projects 
    WHERE client_id IN (
...
UNION ALL
SELECT 'Remaining verification_reports' as check_type, COUNT(*) as count
...
SELECT 'FINAL USER RECORD DELETION COMPLETED SUCCESSFULLY' as final_status;
