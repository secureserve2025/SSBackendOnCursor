-- Projects System Schema
-- This schema creates tables for projects, project files, and deliverables
-- with proper foreign key relationships and auto-generation functions
...
CREATE INDEX IF NOT EXISTS idx_deliverables_order ON deliverables(project_id, deliverable_order);

-- 5. Create function to auto-generate project IDs
...
-- 6. Create trigger to auto-assign project_id when project is created
...
-- 7. Create function to validate freelancer ID exists
...
-- 8. Create function to get project with all related data
...
-- 9. Create function to clean up project files on project deletion
...
-- 11. Create storage bucket for project files
...
-- 14. Create view for project summary
