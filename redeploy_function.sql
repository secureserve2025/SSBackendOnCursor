-- Redeploy the freelancer validation function
-- This will ensure the latest version is active
...
-- Test the redeployed function
SELECT '=== TESTING REDEPLOYED FUNCTION ===' as test_header;

-- Test with the existing freelancer
SELECT 'Test with F308208874:' as test_case;
SELECT * FROM validate_freelancer_complete('F308208874');

-- Test with non-existent freelancer
SELECT 'Test with non-existent ID:' as test_case;
