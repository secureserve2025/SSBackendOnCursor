...
-- 6. Drop and recreate send_checklist_to_freelancer function
...
-- 7. Drop and recreate add_sent_to_freelancer_field function
DROP FUNCTION IF EXISTS add_sent_to_freelancer_field();
