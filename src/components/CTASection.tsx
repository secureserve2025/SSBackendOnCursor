          ...
          <div className="max-w-lg mx-auto bg-gray-800 rounded-2xl p-8 border border-purple-500/30">
            <div className="flex items-center space-x-2 mb-6">
              <svg className="h-6 w-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m3 3 3 9-3 9 19-9z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m6 12 16-6" />
              </svg>
